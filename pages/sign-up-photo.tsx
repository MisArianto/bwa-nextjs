		                ...
		                <div className="form-input d-md-block d-flex flex-column">
		                    <div>
		                        <div className="mb-20">
		                            <div className="image-upload text-center">
		                                <label for="avatar">
		                                    <Image src="/icon/upload.svg" width={120} height={120} alt="icon upload" />
		                                </label>
		                    ...
		                    <div className="button-group d-flex flex-column mx-auto">
		                        <Link href="/sign-up-photo-success">
		                        	<a className="btn btn-create fw-medium text-lg text-white rounded-pill mb-16" role="button">Create My Account</a>
		                        </Link>
