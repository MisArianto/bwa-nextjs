			...
			<section className="sign-up-success mx-auto pt-md-179 pb-md-179 pt-150 pb-100">
		        <div className="container-fluid">
		            <div className="text-center">
		                <Image src="/icon/uploadSuccess.svg" width={316} height={300} alt="upload success" />
		            </div>
		            ...
		            <div className="button-group d-flex flex-column mx-auto">
		                <Link href="/"><a className="btn btn-top-up fw-medium text-lg text-white rounded-pill"
		                    role="button">Top
		                    Up</a></Link>
		            </div>
		        </div>
