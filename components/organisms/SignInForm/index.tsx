	...
	return (
		<>
            ...
            <div className="button-group d-flex flex-column mx-auto pt-50">
                <Link href="/"><a className="btn btn-sign-in fw-medium text-lg text-white rounded-pill mb-16"
                     role="button">Continue to Sign In</a></Link>
                <Link href="/sign-up"><a className="btn btn-sign-up fw-medium text-lg color-palette-1 rounded-pill"
                     role="button">Sign
                    Up</a></Link>
            </div>
		</>
